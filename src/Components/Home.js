...
import Sensex from "../assests/sensex.png"

function Home() {
    return (
        <section className='container-fluid '>
            <div className="row" style={{ backgroundColor: "#ECFAFE", minHeight: "60vh" }}>
                <div className='d-flex mt-5  align-items-center flex-column'>
                    <h1 className='text-primary fw-bold' style={{ fontSize: "4vw" }} >CONVERSATIONAL</h1 >
                    <h1 className='text-danger fw-bold ' style={{ fontSize: "4vw" }}>AI CRM</h1>
                    <h6 className='mt-3 ' style={{ fontSize: "1.5vw" }}> Accelerate your Business Revenue with an AI-powered Chatbot CRM</h6>
            ...
            <div className='' style={{ backgroundColor: "#ECFAFE" }}>
                <div className="text-center">
                    <h1 className="fw-bold " style={{ fontSize: "4vw" }}>All of what your business needs <br />
                        in one space
                    </h1>
                </div>
            ...
            <div className='shadow p-3 mb-5 mt-3 ' style={{ backgroundColor: "#ECFAFE", }}>
                ...
                <div className='row mt-4  pb-3'>
                    ...
                    <div className='col-md-6 col-12  justify-content-center mt-3 '>
                        <h1 className='text-center  fw-bold' style={{ fontSize: "3vw" }}> Chatbot CRM
                        </h1>
                        <p className=' text-muted text-center mt-5'> Supercharge your team’s productivity with ECS
            ...
            <div className=' container '>
                <div className='row pt-3'>
                    <div className=' d-flex justify-content-center  align-items-center flex-column '>
                        <h1 className='fw-bold ' style={{ fontSize: "3vw" }}>Key Features</h1>
                        <p className='text-muted pb-5' style={{ fontSize: "1.5vw" }}>
                            Experience Robust Automation and AI-Powered Insights with ECS Cloud, streamlining operations whil
                        ...
                        <div className='card key-features h-75 shadow p-3 mb-5 '>
                            <div className='row'>
                                ...
                                <div className='col-8 d-flex flex-column justify-content-center'>
                                    ...
                                    <p className=' text-muted m-0'> Omni-channel chatbot:
                        ...
                        <div className='card key-features h-75 shadow p-3 mb-5 '>
                            <div className='row'>
                                ...
                                <div className='col-8 d-flex flex-column justify-content-center'>
                                    ...
                                    <p className=' text-muted m-0'> Organize contacts, track
                        ...
                        <div className='card key-features h-75 shadow p-3 mb-5 '>
                            <div className='row'>
                                ...
                                <div className='col-8 d-flex flex-column justify-content-center'>
                                    ...
                                    <p className=' text-muted m-0'> SMS and social media
                        ...
                        <div className='card key-features h-75 shadow p-3 mb-5 '>
                            <div className='row'>
                                ...
                                <div className='col-8 d-flex flex-column justify-content-center'>
                                    ...
                                    <p className=' text-muted m-0'>Lead capture forms,
                                        conversion tracking, and third
                                        party integration.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='card key-features h-75 shadow p-3 mb-5 '>
                            <div className='row'>
                                ...
                                <div className='col-8 d-flex flex-column justify-content-center'>
                                    ...
                                    <p className=' text-muted m-0'>Online appointment booking,
                        ...
                        <div className='card key-features h-75 shadow p-3 mb-5 '>
                            <div className='row'>
                                ...
                                <div className='col-8 d-flex flex-column justify-content-center'>
                                    ...
                                    <p className=' text-muted m-0'> Track marketing and sales
                                        performance, generating
                                        reports on key metrics.</p>
                                </div>
                            </div>
                        </div>
                    </div>
