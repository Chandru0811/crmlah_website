  ...
  return (
    <section style={{ backgroundColor: "#ECFAFE" }}className="p-5">
      ...
      <div className="   text-center pt-5">
        ...
        <h1 className=" fw-bold ">App Platform with AI-Powered Capabilities</h1>
        <p className="p-5 fw">
          CRMLAH is a suite of CRM App platform featuring an AI-powered Chatbot,
          customer relationship <br /> management, marketing automation, website
          building capabilities, email marketing tools, loyalty programs,
          <br />
